...
| [adr-2609070004056820](2609070004056820-the-app-s-three-locks-have-one-order-the-pool-s-mutex-then-t.md) | The app's three locks have one order: the pool's mutex, then the configuration's, and a settings save serialises above both | accepted | 2026-09-07 |
