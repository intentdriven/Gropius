...
Every model in memory is charged its size on disk plus a fifth, and the budget
is 60% of this Mac's physical RAM. The figure beside the boxes is that sum for
the models you have ticked.
...
memory and goes back to being evictable like any other.
